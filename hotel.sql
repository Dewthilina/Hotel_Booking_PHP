...
-- Insert Sample Data
INSERT INTO `room_category` (`roomname`, `no_bed`, `bedtype`, `facility`, `price`) VALUES
('Deluxe Room', 1, 'King', 'Wi-Fi, TV, Air Conditioning', 1500.00),
('Standard Room', 2, 'Queen', 'Wi-Fi, TV, Breakfast Included', 1200.00),
('Suite', 3, 'King', 'Wi-Fi, TV, Mini Bar, Jacuzzi', 3000.00);
